...
public class TimeSync {
    ...
    private static final int MIN_UNIQUE_FRAMES = 10;
    private static final int MIN_FRAME_ADVANTAGE = 3;
    private static final int MAX_FRAME_ADVANTAGE = 9;
    ...
    public void advance_frame(GameInput input, int advantage, int radvantage) {
        last_inputs[input.getFrame() % last_inputs.length] = input;
